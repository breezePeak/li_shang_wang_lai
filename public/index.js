    ...
    children: [
      {
        ...
        helper: '评论了你的作品，需要回评',
        children: [
          { id: 'replyPending', label: '待回评', icon: 'fa-reply', count: statsData.pendingReplies || 0, tone: 'work', helper: '等待回评处理' },
      ...
      },
      {
        ...
        label: '回复我的',
        icon: 'fa-reply',
        count: statsData.collectedReplies || 0,
        tone: 'muted',
        helper: '回复了你的评论，暂不处理',
      },
      {
        ...
        label: '关注',
        icon: 'fa-user-plus',
        count: statsData.collectedFollows || 0,
        tone: 'muted',
        helper: '关注了你，暂不处理',
      },
      {
